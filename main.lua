...
local speedValue = 1000 -- İSTEDİĞİN 1000 HIZI

-- GUI
local gui = Instance.new("ScreenGui", CoreGui)
gui.Name = "GREENHUB_STABLE"
...
sub.Font = Enum.Font.GothamBlack -- GOTHAM BLACK
sub.TextSize = 12

--------------------------------------------------
-- HYPER SPEED (1000 SEVİYESİ)
--------------------------------------------------
...
-- SABİT 1000 HIZ DÖNGÜSÜ
RunService.Stepped:Connect(function()
    if hyperActive and player.Character and player.Character:FindFirstChild("Humanoid") then
        player.Character.Humanoid.WalkSpeed = speedValue -- TAM OLARAK 1000
    end
end)

--------------------------------------------------
-- TOGGLE & LOGO ANIMATION (GELİŞMİŞ)
--------------------------------------------------
btn.MouseButton1Click:Connect(function()
    menu.Visible = not menu.Visible
    
    if menu.Visible then
        -- Menü Açıldığında Logo Parlasın
        TweenService:Create(btn, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(20, 20, 20), TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        TweenService:Create(btnStroke, TweenInfo.new(0.3), {Color = Color3.fromRGB(0, 255, 120), Thickness = 3}):Play()
    else
        -- Menü Kapandığında Eski Haline Dönsün
