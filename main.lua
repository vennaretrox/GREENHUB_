...
--------------------------------------------------
-- OMNI-DIRECTIONAL PROTECTION (20M CEHENNEM)
--------------------------------------------------
                ...
                if (player.Character.HumanoidRootPart.Position - vHrp.Position).Magnitude < 30 then
                    task.spawn(function()
                        ...
                        for i = 1, 400 do
                            if vHrp then 
                                vHrp.Anchored = true
                                vHrp.CFrame = startCF * CFrame.Angles(0, math.rad(i*20), 0)
                            end
        ...
        for _, v in pairs(Players:GetPlayers()) do
            if v ~= player and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if dist < 20 then
                    ...
                    vHrp.Velocity = Vector3.new(0, -1500, 0)
                    vHrp.CFrame = vHrp.CFrame * CFrame.new(0, 0, 5.5) * CFrame.Angles(0, math.rad(15), 0)
                end
            end
        end
    end
